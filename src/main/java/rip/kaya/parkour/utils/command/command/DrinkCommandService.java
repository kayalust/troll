...
import rip.kaya.parkour.utils.command.annotation.Duration;
import rip.kaya.parkour.utils.command.annotation.Sender;
import rip.kaya.parkour.utils.command.annotation.Text;
import rip.kaya.parkour.utils.command.argument.ArgumentParser;
import rip.kaya.parkour.utils.command.argument.CommandArgs;
import rip.kaya.parkour.utils.command.exception.*;
import rip.kaya.parkour.utils.command.modifier.DrinkModifier;
import rip.kaya.parkour.utils.command.modifier.ModifierService;
import rip.kaya.parkour.utils.command.parametric.BindingContainer;
import rip.kaya.parkour.utils.command.parametric.DrinkBinding;
import rip.kaya.parkour.utils.command.parametric.DrinkProvider;
import rip.kaya.parkour.utils.command.parametric.ProviderAssigner;
import rip.kaya.parkour.utils.command.parametric.binder.DrinkBinder;
import rip.kaya.parkour.utils.command.provider.*;
import rip.kaya.parkour.utils.command.provider.spigot.CommandSenderProvider;
import rip.kaya.parkour.utils.command.provider.spigot.ConsoleCommandSenderProvider;
import rip.kaya.parkour.utils.command.provider.spigot.PlayerProvider;
import rip.kaya.parkour.utils.command.provider.spigot.PlayerSenderProvider;
    ...
    private void finishExecution(@Nonnull CommandSender sender, @Nonnull DrinkCommand command, @Nonnull String label, @Nonnull String[] args) {
        ...
        try {
            ...
            try {
                ...
                sender.sendMessage(ChatColor.RED + "Failed to execute the command! Please check the console for more details.");

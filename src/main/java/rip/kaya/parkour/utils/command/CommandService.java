package rip.kaya.parkour.utils.command;

import org.bukkit.plugin.java.JavaPlugin;
import rip.kaya.parkour.utils.command.command.DrinkAuthorizer;
import rip.kaya.parkour.utils.command.command.DrinkCommandContainer;
